...
extension PlaylistViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        let headerViewModel = PlaylistHeaderViewModels(name: playlist.name, ownerName: playlist.owner.display_name, description: playlist.description, artWorkURL: URL(string: playlist.images.first?.url ?? ""))
...
extension PlaylistViewController: PlaylistHeaderCollectionReusableViewDelegate {
    ...
    func playlistHeaderCollectionReusableViewDidTappedPlayAllButton(_header: PlaylistHeaderCollectionReusableView) {
        PlaybackPresenter.shared.startPlaybackAudioTracks(from: self, tracks: tracks)
    }
